...
public class _CompteStub extends org.omg.CORBA.portable.ObjectImpl implements BourseCorba.Compte
{
  ...
  public void enregistrerClientAlarme (BourseCorba.ClientAlarme ca)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("enregistrerClientAlarme", true);
                BourseCorba.ClientAlarmeHelper.write ($out, ca);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                enregistrerClientAlarme (ca        );
            } finally {
                _releaseReply ($in);
            }
  } // enregistrerClientAlarme

  public BourseCorba.Alarme[] getAlarmes ()
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("getAlarmes", true);
                $in = _invoke ($out);
                BourseCorba.Alarme $result[] = BourseCorba.ListeAlarmesHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
